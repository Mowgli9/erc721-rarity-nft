...
def get_rarity(breed_number):
    switch = {0: "Common", 1: "Rare", 2: "Super Rare",3: "Epic", 4:"Leeeeeeeeeeeeeegendary"}
    return switch[breed_number]


def fund_with_link(
    contract_address,link_address, account, amount=1000000000000000000
):  
